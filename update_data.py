...
indicators["us_10y"] = {"label": "US 10Y Treasury Yield", "unit": "%", "group": "Rates & Bonds", "history": series_history("DGS10", 365)}
indicators["fed_rate"] = {"label": "Fed Funds Rate", "unit": "%", "group": "Rates & Bonds", "history": series_history("FEDFUNDS", 60)}

indicators["us_cpi_yoy"] = {"label": "US Inflation (YoY)", "unit": "%", "group": "Growth & Prices", "history": yoy_history("CPIAUCSL", 60)}
indicators["us_unemployment"] = {"label": "US Unemployment", "unit": "%", "group": "Growth & Prices", "history": series_history("UNRATE", 60)}
indicators["gdp_growth"] = {"label": "US GDP Growth (QoQ annualized)", "unit": "%", "group": "Growth & Prices", "history": series_history("A191RL1Q225SBEA", 20)}
indicators["us_debt_gdp"] = {"label": "US Federal Debt (% of GDP)", "unit": "%", "group": "Growth & Prices", "history": series_history("GFDEGDQ188S", 20)}

indicators["sp500"] = {"label": "S&P 500", "unit": "", "group": "Markets", "history": series_history("SP500", 365)}
indicators["dollar_index"] = {"label": "US Dollar Index", "unit": "", "group": "Markets", "history": series_history("DTWEXBGS", 365)}
indicators["oil_wti"] = {"label": "Crude Oil (WTI)", "unit": " $/bbl", "group": "Markets", "history": series_history("DCOILWTICO", 365)}
